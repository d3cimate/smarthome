...
window.getWindows = async function () 
{
    try 
    {
        ...
        if(ultrasonic1 < 10)
        {
            document.getElementById('bedroom1window').textContent = `Bedroom 1 Window Open.`;
            openWindows=openWindows+1;
        }
        else
        {
            document.getElementById('bedroom1window').textContent = `Bedroom 1 Window Closed.`;
        }

        if(ultrasonic2 < 10)
        {
            document.getElementById('bedroom2window').textContent = `Bedroom 2 Window Open.`;
            openWindows=openWindows+1;
        }
        else
        {
            document.getElementById('bedroom2window').textContent = `Bedroom 2 Window Closed.`;
        }

        if(ultrasonic3 < 10)
        {
            document.getElementById('livingroomwindow').textContent = `Living Room Window Open.`;
            openWindows=openWindows+1;
        }
        else
        {
