...
window.getDoors = async function () 
{
    try 
    {
        ...
        if(!door1)
        {
            document.getElementById('bedroom1door').textContent = `Bedroom 1 Door Unlocked.`;
            openDoors=openDoors+1;
        }
        else
        {
            document.getElementById('bedroom1door').textContent = `Bedroom 1 Door Locked.`;
        }

        if(!door2)
        {
            document.getElementById('bedroom2door').textContent = `Bedroom 2 Door Unlocked.`;
            openDoors=openDoors+1;
        }
        else
        {
            document.getElementById('bedroom2door').textContent = `Bedroom 2 Door Locked.`;
        }

        if(!door3)
        {
            document.getElementById('livingroomdoor').textContent = `Living Room Door Unlocked.`;
            openDoors=openDoors+1;
        }
        else
        {
            document.getElementById('livingroomdoor').textContent = `Living Room Door Locked.`;
        }
    } 
    catch (error) 
    {
